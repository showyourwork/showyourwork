...
% Should we add a showyourwork watermark?
\newif\ifAddWatermark
...
% Note that \syw@wmkX and \syw@wmkY are defined
% in showyourwork-metadata.tex
...
\ifAddWatermark
  \AtBeginDocument{%
    ...
    \begin{tikzpicture}[remember picture,overlay]%
      \node [anchor=west] at ($(current page.north west) + (\syw@wmkX in + \syw@wmkXOffset in, \syw@wmkY in + \syw@wmkYOffset in)$) [rotate=\syw@wmkAngle] {\syw@Watermark};%
    \end{tikzpicture}%
    \makeatother%
  }
\fi
