...
% Define stamp
% Note that \syw@stampSize is defined
% in showyourwork-metadata.tex
\newcommand{\syw@Stamp}{%
  \href{https://github.com/showyourwork/showyourwork}{%
...
% Note that \syw@stampX and \syw@stampY are defined
% in showyourwork-metadata.tex
...
\ifAddStamp
  \AtBeginDocument{%
    ...
    \begin{tikzpicture}[remember picture,overlay]%
      \node at ($(current page.north east) - (\syw@stampX in + \syw@stampXOffset in + \syw@stampRadius in, \syw@stampY in + \syw@stampYOffset in + \syw@stampRadius in)$) [rotate=\syw@stampAngle] {\syw@Stamp};%
    \end{tikzpicture}%
    \makeatother%
  }
\fi
