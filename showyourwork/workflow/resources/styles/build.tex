...
\newcommand{\syw@GitHubLink}{%
  \href{\syw@url/tree/\syw@sha/}{\color{sywBlue}\faGithub}%
}
\newcommand{\syw@GitHubActionsLink}{%
  \href{\syw@url/actions/runs/\syw@runid/}{\color{sywGreen}\faCheckCircle}%
}

% TODO: Add watermarks! Make position configurable in the `showyourwork.yml' config,
% imported above from `showyourwork-metadata.tex', which is generated in
