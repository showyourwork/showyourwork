...
\ifAddStamp
  ...
  \AtBeginDocument{%
    \makeatletter%
    \pgfmathsetmacro{\radius}{\syw@stampSize*0.666}%
    ...
    \pgfmathsetmacro{\ax}{\radius*cos(\syw@stampAngle)}%
    \pgfmathsetmacro{\ay}{\radius*sin(\syw@stampAngle)}%
    \href{\syw@url/tree/\syw@sha/}{%
      \begin{tikzpicture}[remember picture,overlay]
        ...
        \draw[draw=none,postaction={decorate},decoration={
          text along path,text={|\syw@stampFormat|\syw@shortUrl},
          text align=center,text color=sywStampRed}]
          ($(STAMP.center) - (\ax in, \ay in)$)
          arc
          [start angle={\syw@stampAngle+180},
          end angle={\syw@stampAngle+360},
          radius=\radius in];
      \end{tikzpicture}%
    }%
    \makeatother%
