...
\textbf{How do I include figures that aren't generated by a \texttt{Python} script?}
...
\textbf{How do I include datasets?}
Experimental or observational datasets can be included in the \texttt{data} directory. Note that you'll have to \texttt{--force} add them, since they are not tracked by default. If they are larger than about 1 MB, we recommend you instead host them externally on \href{https://zenodo.org/}{Zenodo} and download them in your figure scripts. We'll add a feature to cache external datasets on the \texttt{GitHub Actions} runner soon.
