...
\def\addvalue#1#2{\expandafter\gdef\csname syw@data@\detokenize{#1}\endcsname{\detokenize{#2}}}
\def\usevalue#1{%
  \ifcsname syw@data@\detokenize{#1}\endcsname%
    \csname syw@data@\detokenize{#1}\expandafter\endcsname%
  \else%
    KEYNOTFOUND%
  \fi%
}
