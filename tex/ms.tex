...
\begin{figure}[ht!]
    \begin{centering}
        \includegraphics[width=0.5\linewidth]{mandelbrot.pdf}
        \caption{
...
\begin{figure}[ht!]
    \begin{centering}
        \includegraphics[width=0.4\linewidth]{koch1.pdf}
        \includegraphics[width=0.4\linewidth]{koch2.pdf}
        \caption{
...
\begin{figure}[ht!]
    \begin{centering}
        \includegraphics[width=0.5\linewidth]{fibonacci.pdf}
        \caption{
            Another sample plot.
...
\begin{figure}[ht!]
    \begin{centering}
        \includegraphics[width=0.5\linewidth]{broccoli.pdf}
        \caption{
...
Finally, here is an inline figure that's not part of a \verb+figure+ environment: \includegraphics[width=1em]{inline.pdf}. Since \texttt{showyourwork} can't automatically infer the script that generated it, a custom rule must be included in the \texttt{Snakefile} to produce it.
