...
def get_logger():
    ...
    if not logger.handlers:
        ...
        error_file = paths.logs / "showyourwork_errors.log"
...
def clear_snakemake_errors():
    error_file = paths.logs / "snakemake_errors.log"
...
def setup_logging(debug=False, verbose=False, logfile=None):
    ...
    if not hasattr(snakemake_logger, "custom_error_handler"):
        ...
        snakemake_logger.logger.addHandler(snakemake_logger.custom_error_handler)
