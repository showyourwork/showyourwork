...
%
To get started with \texttt{showyourwork}, create a new \texttt{GitHub} repository based on the template that generated this article by clicking \href{https://github.com/rodluger/showyourwork-template/generate}{here}.
...
%
To enable local builds of your article, install the \texttt{showyourwork} package, which requires the \href{https://www.anaconda.com/products/individual}{conda} package manager:
%
\begin{verbatim}
...
\end{verbatim}
%
in the top level of your repository to build your paper.
